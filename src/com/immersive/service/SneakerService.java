...
public class SneakerService extends Service {
    ...
    public void onCreate() {    
        ...
        try {    
            mStartForeground = SneakerService.class.getMethod("startForeground", mStartForegroundSignature);    
            mStopForeground = SneakerService.class.getMethod("stopForeground", mStopForegroundSignature);    
